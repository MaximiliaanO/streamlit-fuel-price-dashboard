...
class StreamlitCharts():
    ...
    def bgt_diesel_chart(self):
        # Budget branstofpompen dataframe & chart benzine
        bgt_dta = self.db.get_price_data_gas(DB_QUERIES.DIESEL_QUERY_BUDGET)
    ...
    def prem_diesel_chart(self):
        # Budget branstofpompen dataframe & chart benzine
        prem_dta = self.db.get_price_data_gas(DB_QUERIES.DIESEL_QUERY_PREMIUM)
    ...
    def type_chart(self):
        dta = self.db.get_price_data_gas(DB_QUERIES.PUMP_TYPE_QUERY)
